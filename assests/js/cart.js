...
cart.addEventListener("click", (e) => {
  var addOnName, price, addsOnquantity, addOntotal;
  ...
  if (
    ...
    addonItems.push({ addOnName, price, addsOnquantity, addOntotal });
  }
});
...
addToCartBtn.addEventListener("click", (e) => {
  ...
  foodVarients.push({ itemName, varient, quantity, foodPrice, foodTotal });
  itemsOnCart.push({ foodVarients, addonItems });
  console.log(itemsOnCart);
  // let childWin = remote.getGlobal("childWin");
  // if (childWin) childWin.webContents.send("itemsOnBasket", itemsOnCart);
